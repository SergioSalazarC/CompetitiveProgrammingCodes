...
public class SPOJ_QUEST4 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while(t-->0){
            ...
            for (long i = 0; i < m; i++) {
                st = new StringTokenizer(in.readLine()," ");
                int a = Integer.parseInt(st.nextToken())+120;
                int b = Integer.parseInt(st.nextToken())+240;
                addEdge(grafo,a,b,1000);
            }

            for (int i = 0; i < 120; i++) {
                addEdge(grafo,i,i+120,1);
                addEdge(grafo,i+240,i+360,1);
            }

            for (int i = 0; i < 120; i++) {
                addEdge(grafo,480,i,1);
                addEdge(grafo,i+360,481,1);
            }


            long sol = maxFlow(grafo,480,481);
